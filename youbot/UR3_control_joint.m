...
[joint1,joint1d,joint1dd]=tpoly(0*pi/180,90*pi/180,N_step);
[joint2,joint2d,joint2dd]=tpoly(0*pi/180,90*pi/180,N_step);
[joint3,joint3d,joint3dd]=tpoly(0*pi/180,90*pi/180,N_step);
[joint4,joint4d,joint4dd]=tpoly(0*pi/180,90*pi/180,N_step);
[joint5,joint5d,joint5dd]=tpoly(0*pi/180,90*pi/180,N_step);
[joint6,joint6d,joint6dd]=tpoly(0*pi/180,90*pi/180,N_step);

[joint11,joint11d,joint11dd]=tpoly(90*pi/180,0*pi/180,N_step);
[joint22,joint22d,joint22dd]=tpoly(90*pi/180,0*pi/180,N_step);
[joint33,joint33d,joint33dd]=tpoly(90*pi/180,0*pi/180,N_step);
[joint44,joint44d,joint44dd]=tpoly(90*pi/180,0*pi/180,N_step);
[joint55,joint55d,joint55dd]=tpoly(90*pi/180,0*pi/180,N_step);
